...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!wereRequiredFieldsSubmitted($_POST, array('first_name', 'last_name', 'email', 'phone1', 'phone1type'))) {
        echo "Args missing";
        die();
    }
    ...
    <body>
        ...
        <main class="login">
            ...
            <form id="coordinator_board_add" method="post">
                ...
                <select id="phone1type" name="phone1type" required>
                ...
                <input type="text" id="emergency_last_name" name="emergency_last_name" placeholder="Enter last name">
