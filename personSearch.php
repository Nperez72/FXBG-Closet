...
<main>
    <div class="main-content-box w-[80%] p-8">
        ...
        if (isset($_GET['name']) || isset($_GET['id']) || isset($_GET['phone']) || isset($_GET['zip']) || isset($_GET['role']) || isset($_GET['status']) || isset($_GET['photo_release'])) {
            ...
            } elseif (!valueConstrainedTo($role, ['admin', 'participant', 'superadmin', 'volunteer', ''])) {
                echo '<div class="error-block">The system did not understand your request.</div>';
            } elseif (!valueConstrainedTo($status, ['Active', 'Inactive', ''])) {
                echo '<div class="error-block">The system did not understand your request.</div>';
            } elseif (!valueConstrainedTo($photo_release, ['Restricted', 'Not Restricted', ''])) {
                echo '<div class="error-block">The system did not understand your request.</div>';
            } else {
        ...
        ?>
            ...
            <div>
                ...
                <input type="text" id="name" name="name" class="w-full" value="<?php if (isset($name)) {
                    echo htmlspecialchars($_GET['name']);
                                                                               } ?>" placeholder="Enter the user's first and/or last name">
            </div>

            <div>
                <label for="id">Username</label>
                <input type="text" id="id" name="id" class="w-full" value="<?php if (isset($id)) {
                    echo htmlspecialchars($_GET['id']);
                                                                           } ?>" placeholder="Enter the user's username (login ID)">
            </div>

            <div>
                <label for="phone">Phone Number</label>
                <input type="tel" id="phone" name="phone" class="w-full" value="<?php if (isset($phone)) {
            ...
            <div>
                ...
                <input type="text" id="zip" name="zip" class="w-full" value="<?php if (isset($zip)) {
                    echo htmlspecialchars($_GET['zip']);
                                                                             } ?>" placeholder="Enter the user's zip code">
            </div>
            ...
            <div>
                ...
                <select id="role" name="role" class="w-full">
                    ...
                    <option value="volunteer" <?php if (isset($role) && $role == 'volunteer') {
                        echo 'selected';
                                              } ?>>Volunteer</option>
                    <option value="participant" <?php if (isset($role) && $role == 'participant') {
                        echo 'selected';
                                                } ?>>Participant</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select id="status" name="status" class="w-full">
                    <option value="">Any</option>
                    <option value="Active" <?php if (isset($status) && $status == 'Active') {
                        echo 'selected';
                                           } ?>>Active</option>
                    <option value="Inactive" <?php if (isset($status) && $status == 'Inactive') {
                        echo 'selected';
                                             } ?>>Archived</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select id="photo_release" name="photo_release" class="w-full">
                    <option value="">Any</option>
                    <option value="Not Restricted" <?php if (isset($photo_release) && $photo_release == 'Not Restricted') {
                        echo 'selected';
                                                   } ?>>Not Restricted</option>
                    <option value="Restricted" <?php if (isset($photo_release) && $photo_release == 'Restricted') {
                        echo 'selected';
                                               } ?>>Restricted</option>
                </select>
            </div>
