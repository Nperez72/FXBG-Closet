...
function show_report($venue)
{
    ...
    if (isset($_POST['report-types'])) {
        ...
        } elseif (in_array('shifts-staffed-vacant', $_POST['report-types'])) {
            report_shifts_staffed_vacant_by_day($from, $to, $venue);
        } elseif (in_array('volunteers', $_POST['report-types'])) {
                report_all_volunteers($name_from, $name_to, $venue, $export);
        } elseif (in_array('emails', $_POST['report-types'])) {
                report_all_emails($name_from, $name_to, $venue, $export);
        } elseif (in_array('information', $_POST['report-types'])) {
...
function display_totals_table($report, $venue)
{
  //Creates a table for the Total Hours report
